...
export function CTA() {
  return (
    <div
      className="anim flex items-center gap-4"
    ...
    >
      ...
      >
        ...
        <span className="relative">View Live Attestation</span>
      </a>
      <a
        href="https://github.com"
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.02] px-5 py-3 text-sm font-medium text-muted transition-all hover:border-white/[0.15] hover:text-white"
      >
